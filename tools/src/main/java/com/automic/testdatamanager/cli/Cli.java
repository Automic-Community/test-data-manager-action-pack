package com.automic.testdatamanager.cli;
...
/**
 * This class is used to parse the arguments against provided options using
 * apache cli library. Further this class provides method to retrieve the
 * argument value.
 */
public class Cli {
